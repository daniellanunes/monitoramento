      ...
      <div className="w-full max-w-[440px] z-10 relative">
        ...
        <div className="glass-panel p-8 rounded-[32px] border border-white/5 shadow-2xl relative overflow-hidden">
          ...
          <div className="flex flex-col items-center text-center mb-8">
            <div className="w-12 h-12 rounded-2xl bg-[#a855f7]/5 border border-[#a855f7]/10 flex items-center justify-center mb-4 text-[#a855f7] shadow-[0_0_20px_rgba(168,85,247,0.05)]">
          ...
          >
            {loading ? (
              ...
              <>
                <svg className="w-4 h-4 text-[#a855f7] fill-current shrink-0" viewBox="0 0 24 24">
                  <path d="M12.24 10.285V13.4h6.887c-.275 1.565-1.88 4.604-6.887 4.604-4.33 0-7.859-3.578-7.859-8s3.529-8 7.859-8c2.46 0 4.105 1.025 5.047 1.926l2.427-2.334C18.155 2.145 15.42 1 12.24 1 6.033 1 1 6.033 1 12.24s5.033 11.24 11.24 11.24c6.478 0 10.793-4.537 10.793-10.985 0-.74-.078-1.3-.173-1.854h-10.62z" />
                </svg>
